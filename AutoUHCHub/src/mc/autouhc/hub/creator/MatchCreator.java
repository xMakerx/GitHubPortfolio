...
public class MatchCreator {
    ...
    // Timer for after the GUI is closed.
    private BukkitTask destroyCooldown;
    ...
    public void setDestroyCooldown(BukkitTask runnable) {
        this.destroyCooldown = runnable;
    }
    
    public BukkitTask getDestroyCooldown() {
        return this.destroyCooldown;
    }
